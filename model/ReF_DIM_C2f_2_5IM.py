...
class enconder_DIM(nn.Module):
    def __init__(self, c1=3, c_hidden=18):
        ...
        self.stage3 = C2f(c1=c_hidden, c2=c_hidden, shortcut=False)
...
class ReF_DIM(nn.Module):
    def __init__(self, n_task=5, c1=3, c_hidden=18):
        ...
        self.pointConv2 = Conv(c1=36, c2=c_hidden)
        self.pointConv3 = Conv(c1=6, c2=3)
    ...
    def forward(self, x):
        ...
        return self.pointConv3(torch.cat([IM, x], 1))

    def get_last_shared_layer(self):
        return self.pointConv3
